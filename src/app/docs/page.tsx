...
export const metadata: Metadata = createPageMetadata({
  title: "Documentation Overview — BehaviourSim",
  description:
    "Official documentation for BehaviourSim: guides, API references, mathematical concepts, domain presets, and CLI tooling for synthetic behavioral data generation.",
  path: "/docs",
  keywords: [
    "BehaviourSim documentation",
    "synthetic behavioral data guide",
    "Python behaviorsim tutorial",
    "behavioral simulation API docs",
    "domain presets guide",
    "Markov simulation reference",
  ],
});

export default function DocsHomePage() {
  const articleSchema = getTechArticleSchema({
    title: "BehaviourSim Documentation Hub & Overview",
    description:
      "Official technical documentation for BehaviourSim: guides, API references, mathematical concepts, domain presets, and CLI tooling.",
    path: "/docs",
  });
  ...
  const headings = [
    { id: "what-is-behaviorsim", title: "What is BehaviourSim?", level: 2 as const },
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="space-y-4 mb-8">
            ...
            <p className="text-base text-foreground-muted leading-relaxed">
              Welcome to the official technical documentation for BehaviourSim—an open-source Python framework
          ...
          <div className="space-y-8 text-sm text-foreground-muted leading-relaxed">
            {/* Section: What is BehaviourSim */}
            <div>
              <h2 id="what-is-behaviorsim" className="text-xl font-semibold tracking-tight text-foreground pt-2 mb-3">
                What is BehaviourSim?
              </h2>
              <p>
                BehaviourSim generates sequential data by modeling agents as discrete state machines. At each
            ...
            <div className="pt-2">
              ...
              <div className="p-4 rounded-lg border border-border bg-surface-elevated flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                  <div className="font-semibold text-foreground text-xs">BehaviourSim 1.0.1 on PyPI &amp; GitHub</div>
