...
export const metadata: Metadata = createPageMetadata({
  ...
  description:
    "Explore practical applications of BehaviourSim: sequential machine learning pipelines, load testing, algorithmic research, and synthetic domain presets with explicit disclaimers.",
  path: "/use-cases",
  keywords: [
    "synthetic sequential use cases",
    "machine learning behavioral testing",
    "recurrent neural network benchmarking",
    "synthetic telemetry pipeline",
    "education behavioral simulation",
    "mobile app funnel simulation",
    "synthetic finance data testing",
    "synthetic healthcare sequence simulation",
  ],
});

export default function UseCasesPage() {
  const articleSchema = getTechArticleSchema({
    title: "Applied Use Cases: Research, ML Development & Software Testing",
    description:
      "Explore practical applications of BehaviourSim: sequential machine learning pipelines, load testing, algorithmic research, and synthetic domain presets with explicit disclaimers.",
    path: "/use-cases",
  });
    ...
    <>
      ...
      <div className="flex flex-col">
          ...
          <Container size="default">
            <div className="max-w-3xl space-y-4">
              ...
              <p className="text-base sm:text-lg text-foreground-muted leading-relaxed">
                ...
                BehaviourSim to build reproducible test benches, benchmark sequential algorithms, and
        ...
        <Section
          ...
          description="BehaviourSim replaces static mock data with mathematically consistent sequential trajectories."
        >
        ...
        <Section
          ...
          description="BehaviourSim includes four built-in domain presets with calibrated state spaces and feature emissions."
          bordered
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="p-6 rounded-lg border border-border bg-surface space-y-4">
              <div className="flex items-center gap-2 text-foreground font-semibold text-sm">
                ...
                <span>Finance: Portfolio Risk &amp; Volatility (Simulation Model)</span>
              </div>
              <p className="text-xs text-foreground-muted leading-relaxed">
              ...
              <div className="p-3.5 rounded border border-semantic-warning-border bg-semantic-warning-bg text-xs text-foreground-muted space-y-1">
                <div className="font-semibold text-semantic-warning flex items-center gap-1.5">
                  ...
                  <span>Financial Simulation Disclaimer</span>
                </div>
            ...
            <div className="p-6 rounded-lg border border-border bg-surface space-y-4">
              <div className="flex items-center gap-2 text-foreground font-semibold text-sm">
                ...
                <span>Healthcare: Vital Sign Trajectories (Simulation Model)</span>
              </div>
              <p className="text-xs text-foreground-muted leading-relaxed">
              ...
              <div className="p-3.5 rounded border border-semantic-warning-border bg-semantic-warning-bg text-xs text-foreground-muted space-y-1">
                <div className="font-semibold text-semantic-warning flex items-center gap-1.5">
                  <AlertCircle className="w-3.5 h-3.5" />
                  <span>Medical &amp; Clinical Simulation Disclaimer</span>
                </div>
                <p className="text-[11px] leading-relaxed text-foreground-subtle">
