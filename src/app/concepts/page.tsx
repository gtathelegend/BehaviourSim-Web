...
export const metadata: Metadata = {
  ...
  description:
    "Learn the foundational principles behind BehaviorSim: hidden behavioral states, stochastic transition dynamics, observable feature emissions, and reproducible sequence generation.",
  alternates: {
    canonical: "https://behavioursim.vedaangsharma.in/concepts",
  },
};
  ...
  return (
    <div className="flex flex-col">
        ...
        <Container size="default">
          <div className="max-w-3xl space-y-4">
            ...
            <p className="text-base sm:text-lg text-foreground-muted leading-relaxed">
              BehaviorSim models agent behavior as a sequence of transitions across discrete internal
      ...
      <Section
        ...
        description="Unlike standard tabular synthesizers that generate independent, identically distributed (IID) rows, BehaviorSim structures data as temporally coherent trajectories."
      >
        <div className="space-y-8">
          <div className="prose dark:prose-invert max-w-none text-sm text-foreground-muted leading-relaxed">
            <p>
              ...
              preceding state at step <code className="font-mono text-foreground">t - 1</code>. BehaviorSim
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          <div className="lg:col-span-7 space-y-4 text-sm text-foreground-muted leading-relaxed">
            ...
            <p>
              ...
              session time or maximum volatility spikes) to trigger state transitions dynamically.
            </p>
          </div>
          ...
          <Card variant="default">
            ...
            <CardContent>
              <CardDescription>
                ...
                Bernoulli, and Categorical distributions. An agent in an &quot;Engaged&quot; state emits higher
                interaction counts than an agent in an &quot;Idle&quot; state.
              </CardDescription>
            </CardContent>
          </Card>
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-6 space-y-3">
            ...
            <p className="text-sm text-foreground-muted leading-relaxed">
              Scientific research demands exact reproducibility. BehaviorSim uses seeded NumPy random generators
