...
export const metadata: Metadata = createPageMetadata({
  ...
  description:
    "Formal methodology, mathematical state transition formulation, 8 supported parametric emission distributions, and explicit synthetic data boundaries.",
  path: "/methodology",
  keywords: [
    "Markov methodology",
    "transition probability matrix",
    "parametric emission distributions",
...
export default function MethodologyPage() {
  const articleSchema = getTechArticleSchema({
    title: "Methodology: Mathematical Foundations & Generative Architecture",
    description:
      "A technical breakdown of the BehaviourSim generative pipeline: state transition graphs, 8 parametric distributions, population heterogeneity, and explicit synthetic data boundaries.",
    path: "/methodology",
  });
    ...
    <>
      ...
      <div className="flex flex-col">
        ...
        <Section
          ...
          description="BehaviourSim formalizes behavioral paths as a discrete-time Markov decision process without external reward feedback."
          bordered
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm text-foreground-muted leading-relaxed">
            <div className="space-y-3">
              ...
              <p>
                ...
                baseline tendencies. BehaviourSim supports multiple profiles within a single simulator run,
            ...
            <div className="space-y-3">
              ...
              <p>
                ...
                configurations and seed guarantees bitwise identical trace outputs across environments.
              </p>
            </div>
          </div>
        </Section>
        ...
        >
          <div className="p-6 rounded-lg border border-semantic-warning-border bg-semantic-warning-bg space-y-4">
            ...
            <div className="space-y-3 text-xs sm:text-sm text-foreground-muted leading-relaxed">
              <p>
                <strong>Synthetic Nature:</strong> All data produced by BehaviourSim is entirely synthetic. It is
              ...
              <p className="text-xs text-foreground-subtle">
                ...
                empirical domain datasets before drawing real-world conclusions.
              </p>
            </div>
          </div>
